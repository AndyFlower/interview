...
- 提供内置的高可用支持部分master不可用时，还是可以继续工作。
...
![MQ示例图10](https://github.com/AndyFlower/interview/blob/master/imgs/zookeeper-centralized-storage.png)

redis 维护集群元数据采用另一个方式， gossip 协议，所有节点都持有一份元数据，不同的节点如果出现了元数据的变更，就不断将元数据发送给其它的节点，让其它节点也进行元数据的变更。
![MQ示例图10](https://github.com/AndyFlower/interview/blob/master/imgs/redis-gossip.png)
...
![hash算法](https://github.com/AndyFlower/interview/blob/master/imgs/hash.png)
...
![hash一致性算法](https://github.com/AndyFlower/interview/blob/master/imgs/consistent-hashing-algorithm.png)
...
![hash一致性算法](https://github.com/AndyFlower/interview/blob/master/imgs/hash-slot.png)
